...
inline mpl::wide_float                       mmlWrap(mpl::wide_float value, const mpl::wide_float &max)       { return mpl::wide_float::mov_if_true(mpl::wide_float::mov_if_true(value, max - (-value % max), value
