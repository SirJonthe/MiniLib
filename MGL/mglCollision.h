...
//	bool Tri_Tri(const mmlVector<3> &a_a, const mmlVector<3> &a_b, const mmlVector<3> &a_c, const mmlVector<3> &b_a, const mmlVector<3> &b_b, const mmlVector<3> &b_c);
	...
	bool Ray_Plane(const mmlVector<3> &ray_origin, const mmlVector<3> &ray_dir, const mmlVector<3> &plane_normal, const mmlVector<3> &plane_point, mglRayCollisionPoint3D *out = NULL);
	...
	mmlVector<3> ClipVelocityByContactNormal(const mmlVector<3> &vel, const mmlVector<3> &contact_normal);
}
